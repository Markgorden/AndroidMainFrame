...
public class DialogUtil {
	public static Dialog getMenuDialog(Activity context, View view,int orient) {
		...
		window.setGravity(orient); // 此处可以设置dialog显示的位置
		
		window.setWindowAnimations(R.style.MenuDialogAnimation); // 添加动画
		return dialog;
	}

	public static Dialog getAlertDialog(Activity context, View view)
	{
		final Dialog dialog = new Dialog(context, R.style.MenuDialogStyle);
		dialog.setContentView(view);
		dialog.setCanceledOnTouchOutside(false);
